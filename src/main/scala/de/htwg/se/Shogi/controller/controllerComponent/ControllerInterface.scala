...
/**
 * An Interface to implement the controller unit for the game Shogi.
 */
trait ControllerInterface extends scala.swing.Publisher {
  ...
  /**
   * The typical size of a Shogi board is 9*9.
   */
  val boardSize = 9
  ...
  /**
   * Creates a new board, which looks like the standard Shogi boards
   */
